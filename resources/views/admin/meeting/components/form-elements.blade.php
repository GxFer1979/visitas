<div class="form-group row align-items-center" :class="{'has-danger': errors.has('CI'), 'has-success': fields.CI && fields.CI.valid }">
    <label for="CI" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.meeting.columns.CI') }}</label>
        ...
        <input type="text"  @change="findData" v-model="form.CI" v-validate="'required|integer'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('CI'), 'form-control-success': fields.CI && fields.CI.valid}" id="CI" name="CI" placeholder="{{ trans('admin.meeting.columns.CI') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('Names'), 'has-success': fields.Names && fields.Names.valid }">
    <label for="Names" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.meeting.columns.Names') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" readonly v-model="form.Names" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('Names'), 'form-control-success': fields.Names && fields.Names.valid}" id="Names" name="Names" placeholder="{{ trans('admin.meeting.columns.Names') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('First_Names'), 'has-success': fields.First_Names && fields.First_Names.valid }">
    <label for="First_Names" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.meeting.columns.First_Names') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" readonly v-model="form.First_Names" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('First_Names'), 'form-control-success': fields.First_Names && fields.First_Names.valid}" id="First_Names" name="First_Names" placeholder="{{ trans('admin.meeting.columns.First_Names') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('Reason'), 'has-success': fields.Reason && fields.Reason.valid }">
    <label for="Reason" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.meeting.columns.Reason') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
            <textarea  v-model="form.Reason" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('Reason'), 'form-control-success': fields.Reason && fields.Reason.valid}" id="Reason" name="Reason" placeholder="{{ trans('admin.meeting.columns.Reason') }}"></textarea>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('Observation'), 'has-success': fields.Observation && fields.Observation.valid }">
    <label for="Observation" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.meeting.columns.Observation') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <textarea v-model="form.Observation" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('Observation'), 'form-control-success': fields.Observation && fields.Observation.valid}" id="Observation" name="Observation" placeholder="{{ trans('admin.meeting.columns.Observation') }}"></textarea>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('With_whom'), 'has-success': fields.With_whom && fields.With_whom.valid }">
    <label for="With_whom" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.meeting.columns.With_whom') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.With_whom" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('With_whom'), 'form-control-success': fields.With_whom && fields.With_whom.valid}" id="With_whom" name="With_whom" placeholder="{{ trans('admin.meeting.columns.With_whom') }}">
